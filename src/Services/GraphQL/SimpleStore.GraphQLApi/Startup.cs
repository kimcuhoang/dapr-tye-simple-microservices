...
namespace SimpleStore.GraphQLApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient(this._serviceOptions.InventoryApi.ServiceName, (sp, client) =>
                {
                    client.BaseAddress = new Uri($"{this._serviceOptions.InventoryApi.RestUri}/graphql");
                }); ;
            ...
            services
                ...
                .AddStitchedSchema(stitchingBuilder =>
                    stitchingBuilder
                        ...
                        .AddSchemaFromHttp(this._serviceOptions.InventoryApi.ServiceName));
