    ...
    public class InventoryMappingProfile : Profile
    {
        public InventoryMappingProfile()
        {
            CreateMap<Inventory, InventoryDto>()
                .ForMember(dest => dest.InventoryId, opt => opt.MapFrom(src => (Guid)src.Id));

            CreateMap<ProductInventory, ProductInventoryDto>()
                .ForMember(dest => dest.ProductInventoryId, opt => opt.MapFrom(src => (Guid)src.Id))
                .ForMember(dest => dest.ProductId, opt => opt.MapFrom(src => (Guid)src.Product.Id))
